...
public class TreeLogic {
    ...
    public static final String ERROR_MSG_DATA_FOR_NON_AN =
        "Found data for non-existant annotation node ";
    ...
    public void setTreeStructure(String familyId, String uplVersion, HashMap <String, Node> nodeLookupTbl) {
    ...
    public void setTreeInfoFromFamilyId(String familyId, String uplVersion, String database) {
        this.familyId = familyId;
        if (null == familyId) {
            return;
        }
...
//                System.out.println(an.getAccession() + " " + an.getPublicId());
        ...
        MSAUtil.parsePIRForNonGO(msaInfo, nodeList);
    }
     ...
     * @return
     */    
    public void setTreeInfoFromNodeId(String annotId, String uplVersion, String database) {
        ...
        setTreeInfoFromFamilyId(familyId, uplVersion, database);
    }
